        ...
        while True:
            ...
            for i in range(n_boxes):
                ...
                if d['level'][i] == 5 and d['width'][i]<200 and d['height'][i]<200 and d["conf"][i] > 80 and (d['width'][i] > 20 and d['height'][i] > 10):
                    ...
                    self.overlay_text = read_frame[text_top:text_top+text_height,
            ...
            if self.overlay_text is not None:
                frame[circle_center[1]-radius-text_height:circle_center[1]-radius, 
                      circle_center[0]+radius+10:circle_center[0]+radius+10+text_width] = self.overlay_text
